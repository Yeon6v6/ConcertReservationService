...
public class SeatReservedEventListener {
    ...
    public void handleBeforeCommit(ConcertSeatReservedEvent event) throws JsonProcessingException {
    ...
    public void handleAfterCommit(ConcertSeatReservedEvent event) throws JsonProcessingException {
